#!/bin/bash
sku_information () {
    product_uid=`sshpass -p '46VNZk7zrWhm' ssh -o StrictHostKeyChecking=no -t gor@10.236.8.46 "/home/gor/easy_console/get_item_uid.sh $1" | head -3 | tail -1 | grep -o '[[:digit:]]*'`
    echo "<br>"
